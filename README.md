...
This was a two-person group project where we had to assess the value of crowdsourced data labelling versus gold-standard (more expensive) datasets when training three supervised machine learning models. Our names are listed as authors on the relevant Python source files and reports.
